...
class RepoDetailsPresenterTest {
    ...
    fun setUp() {
        ...
        whenever(viewModel.contributorsLoaded()).thenReturn(contributorConsumer)
    ...
    fun repoContributors() {
        initPresenter()
        contributors?.let { verify(dataSource).setData(it) }
    }
    ...
    private fun initPresenter() {
        ...
        RepoDetailsPresenter(OWNER, NAME, repoRepository, viewModel, dataSource, Mockito.mock(DisposableManager::class.java))
    }
}