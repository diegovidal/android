...
import com.dvidal.cache.db.ProjectConstants.DELETE_PROJECTS
import com.dvidal.cache.db.ProjectConstants.QUERY_BOOKMARKED_PROJECTS
import com.dvidal.cache.db.ProjectConstants.QUERY_PROJECTS
import com.dvidal.cache.db.ProjectConstants.QUERY_UPDATE_BOOKMARK_STATUS
...
@Dao
abstract class CachedProjecstDao {
