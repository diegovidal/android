    ...
    public void searchPlantsActivityTest2() {
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.actPlants),
                        childAtPosition(
                                allOf(withId(R.id.activity_search_plants),
                                        childAtPosition(
                                                withId(android.R.id.content),
                                                0)),
                                0),
                        isDisplayed()));
        appCompatEditText.perform(replaceText("Redbud"), closeSoftKeyboard());

        ViewInteraction appCompatButton = onView(
                allOf(withId(R.id.btnSearchPlants), withText("Search"),
                        childAtPosition(
                                allOf(withId(R.id.activity_search_plants),
                                        childAtPosition(
                                                withId(android.R.id.content),
